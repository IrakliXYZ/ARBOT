...
# print(rofit(10000, float(funding_rates('ETH-PERP')['funding y']), taker_fee, difference(PERP('ETH-PERP')['PERP_price'], USD('ETH/USD')['USD_price']), 3))
...
print(apr_calculator(yearly_profit_btc, 10000))